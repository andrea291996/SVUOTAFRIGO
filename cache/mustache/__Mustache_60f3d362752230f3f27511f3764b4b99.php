...
class __Mustache_60f3d362752230f3f27511f3764b4b99 extends \Mustache\Template
{
...
';
        $buffer .= $indent . '        <button type="submit" class="btn btn-success">Scarica il manuale d\'uso</button>
';
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '
