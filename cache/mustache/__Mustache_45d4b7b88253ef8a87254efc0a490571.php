...
class __Mustache_45d4b7b88253ef8a87254efc0a490571 extends \Mustache\Template
{
...
';
        $buffer .= $indent . '        <button class="btn btn-primary text-uppercase" href="http://localhost/SVUOTAFRIGO/Documentazione/diagramma_di_flusso_svuotafrigo.drawio.pdf">Scarica il manuale d\'uso</button>
';
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '
