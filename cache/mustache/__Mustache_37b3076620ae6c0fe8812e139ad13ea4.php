...
class __Mustache_37b3076620ae6c0fe8812e139ad13ea4 extends \Mustache\Template
{
...
';
        $buffer .= $indent . '        <button type="submit" class="btn btn-primary text-uppercase">Scarica il manuale d\'uso</button>
';
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '
