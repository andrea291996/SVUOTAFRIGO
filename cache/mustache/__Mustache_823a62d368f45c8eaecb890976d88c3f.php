...
class __Mustache_823a62d368f45c8eaecb890976d88c3f extends \Mustache\Template
{
...
';
        $buffer .= $indent . '        <button type="submit" class="btn btn-success text-uppercase">Scarica il manuale d\'uso</button>
';
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '
...
';
        $buffer .= $indent . '        <p>Se non hai ancora trovato quello che cerchi, contattaci! Un nostro tecnico risponderà entro 24h.</p>
';
