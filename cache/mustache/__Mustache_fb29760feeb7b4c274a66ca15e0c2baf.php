...
class __Mustache_fb29760feeb7b4c274a66ca15e0c2baf extends \Mustache\Template
{
...
';
        $buffer .= $indent . '                    Posso salvare le mie ricette?
';
        $buffer .= $indent . '                </button>
';
        $buffer .= $indent . '                </h3>
';
        $buffer .= $indent . '                <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
';
...
';
        $buffer .= $indent . '                    Sono un utente scemo, come si usa l\'app?
';
        $buffer .= $indent . '                </button>
';
        $buffer .= $indent . '                </h3>
...
';
        $buffer .= $indent . '                    Ci sono anche ricette vegetariane?
';
        $buffer .= $indent . '                </button>
';
        $buffer .= $indent . '                </h3>
...
';
        $buffer .= $indent . '        <button class="btn btn-primary text-uppercase"><a class="button" href="http://localhost/SVUOTAFRIGO/Documentazione/diagramma_di_flusso_svuotafrigo.drawio.pdf">Scarica il manuale d\'uso</a></button>
';
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '    <div class="sfondo_form">
';
        $buffer .= $indent . '        <div class="form">
';
