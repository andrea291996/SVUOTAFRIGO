...
class __Mustache_3a1e2b45787671e0ad9f60f9bb5be901 extends \Mustache\Template
{
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '    <div class="fascia_colorata">
';
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '    <div class="fascia_colorata link">
';
