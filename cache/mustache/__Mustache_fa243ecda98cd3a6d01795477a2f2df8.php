...
class __Mustache_fa243ecda98cd3a6d01795477a2f2df8 extends \Mustache\Template
{
...
';
        $buffer .= $indent . '                <button class="accordion-button border-0" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
';
