...
class __Mustache_eb8afce31ed7c0cb289395730314fcdc extends \Mustache\Template
{
    ...
    public function renderInternal(\Mustache\Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '<h1>assistenza</h1>
';
        $buffer .= $indent . '<div class="accordion container" id="accordionExample">
';
...
';
        $buffer .= $indent . '</div>
';
        $buffer .= $indent . '<p>Scarica il Manuale d\'uso</p>
';
        $buffer .= $indent . '<button type="submit" class="btn btn-success">Invio</button>
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '<h2 class="my-4">Hai bisogno di altre informazioni?</h2>
';
