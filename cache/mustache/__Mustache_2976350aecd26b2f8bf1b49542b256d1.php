...
class __Mustache_2976350aecd26b2f8bf1b49542b256d1 extends \Mustache\Template
{
    ...
    public function renderInternal(\Mustache\Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '<div class="col-md-6 mb-4 contenitore-ricetta">
';
...
';
        ...
        $value = $this->resolveValue($context->find('getTitolo'), $context);
...
';
        ...
        $value = $this->resolveValue($context->find('getTestoDieta'), $context);
        $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
        $buffer .= '</p>
';
        $buffer .= $indent . '            
...
';
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '            <a href="modifica">modifica</a>
';
        $buffer .= $indent . '        </div>
';
        $buffer .= $indent . '    </div>
