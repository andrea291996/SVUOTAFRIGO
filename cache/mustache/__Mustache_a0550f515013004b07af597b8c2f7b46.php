...
class __Mustache_a0550f515013004b07af597b8c2f7b46 extends \Mustache\Template
{
...
';
        $buffer .= $indent . '                <i class="fas fa-filter me-2 text-info"></i>Personalizza la tua ricerca
';
        $buffer .= $indent . '            </h5>
';
        $buffer .= $indent . '        </div>
...
';
        $buffer .= $indent . '                            <i class="fas fa-refrigerator me-2 text-primary"></i>Cosa hai in frigo?
';
        $buffer .= $indent . '                        </label>
';
        $buffer .= $indent . '                        
...
';
        $buffer .= $indent . '                        <i class="fas fa-search-location me-2"></i>Scopri cosa puoi cucinare
';
        $buffer .= $indent . '                    </button>
';
        $buffer .= $indent . '                </div>
