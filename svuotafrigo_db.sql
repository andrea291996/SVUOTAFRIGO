...
CREATE TABLE `ricette` (
  `id` int NOT NULL AUTO_INCREMENT,
  `titolo` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `procedimento` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  ...
  CONSTRAINT `fk_utente` FOREIGN KEY (`id_utente`) REFERENCES `utenti` (`id_utente`) ON UPDATE CASCADE
...
INSERT INTO `ricette` VALUES (1,'Pasta al Pomodoro','Soffriggere il pomodoro e condire la pasta.','Primo',0,0,1,1,0,1,1,1,NULL),(2,'Carbonara','Mescolare uova e pecorino, aggiungere guanciale croccante.','Primo',0,0,0,0,0,0,1,1,NULL),(3,'Risotto allo Zafferano','Tostare il riso e aggiungere brodo e zafferano.','Primo',0,0,1,0,1,0,1,1,NULL),(4,'Hummus di Ceci','Frullare i ceci con olio e limone.','Antipasto',0,0,1,1,1,1,1,1,NULL),(5,'Zucchine saltate','Tagliare le zucchine e saltarle in padella.','Contorno',0,0,1,1,1,1,1,1,NULL);
...
INSERT INTO `utenti` VALUES (1,'irene@esempio.it','ciao','Irene'),(2,'andrea@esempio.it','ciao','andrea'),(3,'franci@esempio.it','ciao','francesco');
...
-- Dump completed on 2026-01-15  8:43:11
